<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ProgramRemarkMng.ascx.cs" Inherits="MOD.Admin.UserControls.UC_ProgramRemarkMng" %>
<div class="rRow">
   <h3><%=GetRes("Info_RemarkMng")%></h3>
   <div class="ListBar">     
       <div class="left"><asp:Literal ID="ltrSelect" runat="server"></asp:Literal></div>
   </div>
