<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_ProgramList.ascx.cs" Inherits="MOD.WebTd.UserControls.UC_ProgramList" %>
<%@ Register Src="UC_CatalogView.ascx" TagName="CatalogView" TagPrefix="UC" %>
<UC:CatalogView ID="UC_CatalogView1" runat="server" />
<div class="sort"><asp:Literal ID="lbSort" runat="server"></asp:Literal></div>
