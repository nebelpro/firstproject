...
<div class="brder">
    <div id="subb"><!-- use the style as subb -->
        <h3><asp:Literal ID="ltrTip" runat="server"></asp:Literal></h3>        
         ...
         <div class="ListBar">     
            <div class="left">
                <asp:Literal ID="ltrBroad" runat="server"></asp:Literal> &nbsp;&nbsp;&nbsp;
                <asp:Literal ID="ltrIptv" runat="server"></asp:Literal>                              
            </div>      
            <div class="right">
        ...
        <ItemTemplate>
          <div class="castblock">
            <table class="castimg">
              <tr><td><img src="<%#MOD.WebUtility.ChannelHelper.GetChannelIcon(Int32.Parse(Eval("CType").ToString()),0) %>" alt="" /></td></tr></table>
            <ul class="CastInfo">
              ...
              <li class="castBtn"><a href="#" onclick="<%# MOD.WebUtility.ChannelHelper.GetChannelUrl(Int32.Parse(Eval("CId").ToString()),0,1)%>"><img src="Images/depend/btn_receive.gif" alt="" /></a>
                <%#MOD.WebUtility.ChannelHelper.OutChannelDetailLink(Int32.Parse(Eval("CId").ToString()),Int32.Parse(Eval("CType").ToString()),1)%>
              </li>
            </ul>
            <hr class="clear" />
          </div>
