<%@ Control Language="C#" AutoEventWireup="true" EnableViewState="false"  CodeBehind="UC_ProgramSearchList.ascx.cs" Inherits="MOD.UI.UserControls.UC_ProgramSearchList" %>
<h3><asp:Literal ID="ltrSearchKey" runat="server"></asp:Literal></h3>  
<asp:Literal ID="ltrListTop" runat="server"></asp:Literal> 
<asp:Repeater ID="rptResultlist" runat="server">
<ItemTemplate>
<div class="prmblock">
...
<asp:Repeater ID="rptProgramList2" runat="server">      
    <HeaderTemplate><table id="ProgramListModel"><tr>
            <th class="w1"></th>
